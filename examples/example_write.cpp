...
int main()
{
    ...
    for (int i = 0; i < 10; ++i)
    {
        ...
        TH1F* h = box->RegTH1<TH1F>(hname, "Histogram - loop", 100, -5, 5);
        h->FillRandom("gaus", 100000);
    }

    TH1F* hist1 = box->RegTH1<TH1F>("dir1/hist1", "Histogram 1", 100, -5, 5);
    TH1F* hist2 = box->RegTH1<TH1F>("hist2", "Histogram 2", 100, -5, 5);
    TH1F* hist3 = box->RegTH1<TH1F>("dir1/dir2/hist3", "Histogram 3", 100, -5, 5);
    TH1F* hist4 = box->RegTH1<TH1F>("@@@d/hist_@@@a_placeholders", "Histogram 4", 100, -5, 5);
